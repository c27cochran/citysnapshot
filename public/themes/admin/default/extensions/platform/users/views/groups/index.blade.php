...
<div class="page-header">
	...
	<h1>{{{ trans('platform/users::groups/general.title') }}}</h1>
...
<table data-source="{{ URL::toAdmin('users/groups/grid') }}" data-grid="main" class="data-grid table table-striped table-bordered table-hover">
	<thead>
		<tr>
